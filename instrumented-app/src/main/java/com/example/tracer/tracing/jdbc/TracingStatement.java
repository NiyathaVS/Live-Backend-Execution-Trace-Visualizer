...
public class TracingStatement implements Statement {
    ...
    public TracingStatement(Statement delegate, SqlTraceListener sqlTraceListener, String preparedSql) {
    ...
    public int[] executeBatch() throws SQLException {
        String sql = preparedSql != null ? preparedSql : "BATCH";
        return trace(sql, () -> delegate.executeBatch());
    }

    private <T> T trace(String sql, SqlCallable<T> callable) throws SQLException {
    ...
    public long[] executeLargeBatch() throws SQLException {
        String sql = preparedSql != null ? preparedSql : "BATCH";
        return trace(sql, () -> delegate.executeLargeBatch());
    }

    @Override
    public long executeLargeUpdate(String sql) throws SQLException {
        return trace(sql, () -> delegate.executeLargeUpdate(sql));
    }

    @Override
    public long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return trace(sql, () -> delegate.executeLargeUpdate(sql, autoGeneratedKeys));
    }

    @Override
    public long executeLargeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return trace(sql, () -> delegate.executeLargeUpdate(sql, columnIndexes));
    }

    @Override
    public long executeLargeUpdate(String sql, String[] columnNames) throws SQLException {
        return trace(sql, () -> delegate.executeLargeUpdate(sql, columnNames));
    }
