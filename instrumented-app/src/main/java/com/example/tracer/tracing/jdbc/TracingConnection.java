...
public class TracingConnection implements Connection {
    ...
    public TracingConnection(Connection delegate, SqlTraceListener sqlTraceListener) {
    ...
    public Statement createStatement() throws SQLException {
        return new TracingStatement(delegate.createStatement(), sqlTraceListener, null);
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new TracingPreparedStatement(delegate.prepareStatement(sql), sqlTraceListener, sql);
    }
